package nexus.io.db.activerecord.generator;
...
public class Generator {
   ...
   *
   * 默认模板为："/nexus/io/db/activerecord/generator/base_model_template.jf"
   */
   ...
   *
   * 默认模板为："/nexus/io/db/activerecord/generator/model_template.jf"
   */
   ...
   *
   * 默认模板为："/nexus/io/db/activerecord/generator/mapping_kit_template.jf"
   */
