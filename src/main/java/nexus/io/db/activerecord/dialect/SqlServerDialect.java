...
public class SqlServerDialect extends Dialect {
  ...
  public void forDbSaveIfAbset(String tableName, String[] pKeys, Row record, StringBuilder sql, List<Object> paras) {
    ...
    sql.append("MERGE INTO [").append(tableName).append("] AS target ").append("USING (SELECT ").append(sourceColumns)
        .append(") AS source ").append("ON ").append(onCondition).append(" ").append("WHEN NOT MATCHED THEN INSERT (")
        .append(insertColumns).append(") ").append("VALUES (").append(insertValues).append(");");
  }
